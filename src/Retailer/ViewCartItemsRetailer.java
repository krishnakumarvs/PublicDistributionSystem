 ...
 * @author USER
 */
public class ViewCartItemsRetailer extends javax.swing.JFrame {
...
myList.add(Integer.parseInt(rs.getString("id")));
            ...
            PaymentRetailer payment = new PaymentRetailer(totalAmount, items, itemsCount, myList);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            List<Integer> myList = new ArrayList<Integer>();
            myList.add(cartId1);
            PaymentRetailer payment = new PaymentRetailer(itemAmount1, itemName1, 1, myList);
            payment.setVisible(true);
            this.dispose();
...
// TODO add your handling code here:
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try {
            List<Integer> myList = new ArrayList<Integer>();
            myList.add(cartId2);
            PaymentRetailer payment = new PaymentRetailer(itemAmount2, itemName2, 1, myList);
            payment.setVisible(true);
            this.dispose();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCartItemsRetailer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCartItemsRetailer().setVisible(true);
            }
        });
    }

 ...
 * @author USER
 */
public class ViewBookedItems extends javax.swing.JFrame {

    /**
     * Creates new form ViewBookedItems
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBookedItems.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBookedItems().setVisible(true);
            }
        });
    }

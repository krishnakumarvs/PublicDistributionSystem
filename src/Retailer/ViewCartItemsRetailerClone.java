 ...
 * @author USER
 */
public class ViewCartItemsRetailerClone extends javax.swing.JFrame {
     ...
     */
    public ViewCartItemsRetailerClone() {
        initComponents();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCartItemsRetailerClone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCartItemsRetailerClone().setVisible(true);
            }
        });
    }

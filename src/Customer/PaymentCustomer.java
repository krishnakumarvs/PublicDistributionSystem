...
public class PaymentCustomer extends javax.swing.JFrame {
    ...
    public PaymentCustomer(float amount, String items, String itemsQuantities, int itemsCount, List<Integer> myList, String itemIds) {
        this.amount = amount;
        this.myList = myList;
        this.items = items;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            int inss = new Dbcon().insert("insert into user_orders (amount, retailer_id, user_id, payment_type, items,items_quantities,item_ids, created_at,no_of_items ) "
                    + " values ("
                    + " " + amount + " , "
                    + " " + HomePageCustomer.retailerId + " , "
                    + " " + HomePageCustomer.userid + " , "
            ...
            if (inss > 0) {
                ResultSet rs = new Dbcon().select("select max(id) from user_orders");
                if (rs.next()) {
                    String retailer_order_id = rs.getString(1);

                    String deleteQuery = "delete from user_cart where id in ( ";
